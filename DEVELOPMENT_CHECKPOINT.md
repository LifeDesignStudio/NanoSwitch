...
- **アプリアイコン表示** — 各サムネイルセル左下に 28×28 アイコン（2026-05-23）
- **ウィンドウ閉じるボタン** — ホバー/選択セルに `xmark.circle` 表示、クリックで AX API 経由クローズ（2026-05-23）
- **Apple HIG 準拠 UI** — `NSVisualEffectView (.hudWindow)` フロストガラス背景・角丸 12pt・フェードアニメーション（2026-05-23）
...
- **閉じるボタンのスタイル** — `xmark.circle` は今後調整予定（ユーザー要望）
...
| 日時 | コミット | 内容 |
|------|---------|------|
| 2026-05-23 | `9c92b77` | **Apple HIG 改善** — NSVisualEffectView・角丸・フェード・ホバー閉じるボタン・アイコン表示 |
| 2026-03-22 | — | **配布準備・寄付導線実装** |
